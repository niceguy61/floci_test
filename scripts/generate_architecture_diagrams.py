...
ICONS = {
    ...
    "cloudwatch_logs": data_uri(ICON_DIR / "management" / "cloudwatch-logs.svg"),
    "ssm_parameter_store": data_uri(ICON_DIR / "management" / "ssm-parameter-store.svg"),
    "secrets_manager": data_uri(ICON_DIR / "security" / "secrets-manager.svg"),
    "kms": data_uri(ICON_DIR / "security" / "kms.svg"),
    "kinesis_data_streams": data_uri(ICON_DIR / "analytics" / "kinesis-data-streams.svg"),
    "cloudformation_stack": data_uri(ICON_DIR / "management" / "cloudformation-stack.svg"),
}
...
DIAGRAMS = {
    ...
    "todo-logs": {
        "title": "Todo Logs",
        "subtitle": "DynamoDB state + CloudWatch Logs observability",
        "size": (1280, 720),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 540, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 540, "label": "Local app runtime"},
        ...
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 175},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 355},
            {"id": "n3", "icon": "application", "label": "Todo API Server", "x": 405, "y": 265},
            {"id": "n4", "icon": "dynamodb_table", "label": "Amazon DynamoDB table\ntodos", "x": 760, "y": 215},
            {"id": "n5", "icon": "cloudwatch_logs", "label": "Amazon CloudWatch Logs\n/floci/todo-logs", "x": 980, "y": 215},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "create / toggle", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 325)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 409), (285, 331)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "state write/read", "source_anchor": (1.0, 0.35), "target_anchor": (0.0, 0.5), "points": [(610, 300), (610, 275)]},
            {"id": "e4", "source": "n3", "target": "n5", "label": "log events", "source_anchor": (1.0, 0.72), "target_anchor": (0.0, 0.5), "points": [(700, 368), (700, 275)]},
        ],
    },
    "alert-center": {
        "title": "Alert Center",
        "subtitle": "SNS fan-out to multiple SQS subscribers",
        "size": (1420, 760),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 560, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 560, "label": "Local app runtime"},
            {"id": "c3", "x": 610, "y": 92, "w": 760, "h": 560, "label": "floci endpoint / AWS local services"},
        ],
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 185},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 365},
            {"id": "n3", "icon": "application", "label": "Alert API Server", "x": 405, "y": 275},
            {"id": "n4", "icon": "sns_topic", "label": "Amazon SNS topic\nalert-center-topic", "x": 760, "y": 275},
            {"id": "n5", "icon": "sqs_queue", "label": "Amazon SQS queue\nsubscriber A", "x": 1030, "y": 165},
            {"id": "n6", "icon": "sqs_queue", "label": "Amazon SQS queue\nsubscriber B", "x": 1030, "y": 385},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "compose alert", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 335)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 419), (285, 341)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "publish", "source_anchor": (1.0, 0.5), "target_anchor": (0.0, 0.5), "points": [(650, 325)]},
            {"id": "e4", "source": "n4", "target": "n5", "label": "fan-out", "source_anchor": (1.0, 0.35), "target_anchor": (0.0, 0.5), "points": [(940, 315), (940, 225)]},
            {"id": "e5", "source": "n4", "target": "n6", "label": "fan-out", "source_anchor": (1.0, 0.65), "target_anchor": (0.0, 0.5), "points": [(940, 335), (940, 445)]},
        ],
    },
    "file-pipeline": {
        "title": "File Pipeline",
        "subtitle": "S3 upload + SQS worker pipeline",
        "size": (1420, 780),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 600, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 270, "h": 600, "label": "Local app runtime"},
            {"id": "c3", "x": 630, "y": 92, "w": 740, "h": 600, "label": "floci endpoint / AWS local services"},
        ],
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 160},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 340},
            {"id": "n3", "icon": "application", "label": "File API Server", "x": 405, "y": 180},
            {"id": "n4", "icon": "application", "label": "Worker", "x": 405, "y": 430},
            {"id": "n5", "icon": "s3_bucket", "label": "Amazon S3 bucket\nfile-pipeline-bucket", "x": 720, "y": 180},
            {"id": "n6", "icon": "dynamodb_table", "label": "Amazon DynamoDB table\nfile_pipeline_jobs", "x": 940, "y": 180},
            {"id": "n7", "icon": "sqs_queue", "label": "Amazon SQS queue\nfile-pipeline-queue", "x": 1160, "y": 180},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "upload file", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 310)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.5), "points": [(300, 394), (300, 240)]},
            {"id": "e3", "source": "n3", "target": "n5", "label": "store original", "source_anchor": (1.0, 0.3), "target_anchor": (0.0, 0.4), "points": [(650, 216)]},
            {"id": "e4", "source": "n3", "target": "n6", "label": "QUEUED status", "source_anchor": (1.0, 0.55), "target_anchor": (0.0, 0.42), "points": [(760, 246)]},
            {"id": "e5", "source": "n3", "target": "n7", "label": "enqueue", "source_anchor": (1.0, 0.8), "target_anchor": (0.0, 0.42), "points": [(860, 276)]},
            {"id": "e6", "source": "n7", "target": "n4", "label": "poll", "source_anchor": (0.0, 0.65), "target_anchor": (1.0, 0.25), "points": [(860, 258), (860, 457)]},
            {"id": "e7", "source": "n4", "target": "n5", "label": "read file", "source_anchor": (1.0, 0.3), "target_anchor": (0.0, 0.7), "points": [(620, 458), (620, 250)]},
            {"id": "e8", "source": "n4", "target": "n6", "label": "PROCESSING / COMPLETED", "source_anchor": (1.0, 0.7), "target_anchor": (0.0, 0.7), "points": [(760, 498), (760, 250)]},
        ],
    },
    "secret-vault": {
        "title": "Secret Vault",
        "subtitle": "Secrets Manager + KMS protection pattern",
        "size": (1280, 720),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 540, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 540, "label": "Local app runtime"},
            {"id": "c3", "x": 610, "y": 92, "w": 620, "h": 540, "label": "floci endpoint / AWS local services"},
        ],
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 175},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 355},
            {"id": "n3", "icon": "application", "label": "Secret API Server", "x": 405, "y": 265},
            {"id": "n4", "icon": "secrets_manager", "label": "AWS Secrets Manager", "x": 760, "y": 215},
            {"id": "n5", "icon": "kms", "label": "AWS Key Management Service", "x": 980, "y": 215},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "save / read secret", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 325)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 409), (285, 331)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "create/get secret", "source_anchor": (1.0, 0.35), "target_anchor": (0.0, 0.5), "points": [(610, 300), (610, 275)]},
            {"id": "e4", "source": "n3", "target": "n5", "label": "kms key reference", "source_anchor": (1.0, 0.72), "target_anchor": (0.0, 0.5), "points": [(700, 368), (700, 275)]},
        ],
    },
    "feature-flags": {
        "title": "Feature Flags",
        "subtitle": "SSM Parameter Store for app flags",
        "size": (1220, 720),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 540, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 540, "label": "Local app runtime"},
            {"id": "c3", "x": 610, "y": 92, "w": 560, "h": 540, "label": "floci endpoint / AWS local services"},
        ],
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 175},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 355},
            {"id": "n3", "icon": "application", "label": "Flag API Server", "x": 405, "y": 265},
            {"id": "n4", "icon": "ssm_parameter_store", "label": "AWS Systems Manager\nParameter Store", "x": 850, "y": 265},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "create / edit flags", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 325)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 409), (285, 331)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "put/get parameters", "source_anchor": (1.0, 0.5), "target_anchor": (0.0, 0.5), "points": [(650, 315)]},
        ],
    },
    "stream-inspector": {
        "title": "Stream Inspector",
        "subtitle": "Kinesis write + read inspection flow",
        "size": (1220, 720),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 540, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 540, "label": "Local app runtime"},
        ...
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 175},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 355},
            {"id": "n3", "icon": "application", "label": "Stream API Server", "x": 405, "y": 265},
            {"id": "n4", "icon": "kinesis_data_streams", "label": "Amazon Kinesis Data Streams\nstream-inspector-stream", "x": 850, "y": 265},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "publish / inspect", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 325)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 409), (285, 331)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "put-record / get-records", "source_anchor": (1.0, 0.5), "target_anchor": (0.0, 0.5), "points": [(650, 315)]},
        ],
    },
    "cloudformation-playground": {
        "title": "CloudFormation Playground",
        "subtitle": "CloudFormation stack provisioning an S3 bucket",
        "size": (1280, 720),
        "containers": [
            {"id": "c1", "x": 40, "y": 92, "w": 240, "h": 540, "label": "Client"},
            {"id": "c2", "x": 320, "y": 92, "w": 250, "h": 540, "label": "Local app runtime"},
        ...
        "nodes": [
            {"id": "n1", "icon": "users", "label": "User", "x": 105, "y": 175},
            {"id": "n2", "icon": "client", "label": "Browser / Web UI", "x": 105, "y": 355},
            {"id": "n3", "icon": "application", "label": "CloudFormation API Server", "x": 405, "y": 265},
            {"id": "n4", "icon": "cloudformation_stack", "label": "AWS CloudFormation stack", "x": 760, "y": 215},
            {"id": "n5", "icon": "s3_bucket", "label": "Amazon S3 bucket resource", "x": 980, "y": 215},
        ],
        "edges": [
            {"id": "e1", "source": "n1", "target": "n2", "label": "stack input", "source_anchor": (0.5, 1.0), "target_anchor": (0.5, 0.0), "points": [(165, 325)]},
            {"id": "e2", "source": "n2", "target": "n3", "label": "HTTP", "source_anchor": (1.0, 0.45), "target_anchor": (0.0, 0.55), "points": [(285, 409), (285, 331)]},
            {"id": "e3", "source": "n3", "target": "n4", "label": "create-stack", "source_anchor": (1.0, 0.35), "target_anchor": (0.0, 0.5), "points": [(610, 300), (610, 275)]},
            {"id": "e4", "source": "n4", "target": "n5", "label": "provision bucket", "source_anchor": (1.0, 0.5), "target_anchor": (0.0, 0.5), "points": [(930, 275)]},
        ],
    },
}
